...
def predict_image(image_path, model, transform, device="cuda", sport="game"):
    model.eval()
    ...
    label = f"{sport.upper()} Game" if output > 0.5 else "Commercial"
...
if __name__ == "__main__":
    ...
    # accuracy, confidence = predict_image('path/to/image.jpg', model, test_transform, device, sport)
